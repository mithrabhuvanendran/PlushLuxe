...
import { addUser, deleteUser, fetchUsers, updateUser } from "../redux/thunk/adminThunk";
...
useEffect(() => {
  ...
  const handleRoleChange = (userId, newRole) => {
    // console.info({id: userId, role:newRole});
                ...
                <tbody>
                    {users.map((user) => (
                        <tr key={user._id} className="border-b border-gray-200 hover:bg-gray-50">
                            ...
                            <td className="p-4">
                                <button onClick={() => handleDeleteUser(user._id)} className="bg-red-500 text-white py-2 px-4 rounded hover:bg-red-600">Delete</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
